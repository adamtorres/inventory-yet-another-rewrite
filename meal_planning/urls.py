...
urlpatterns = [
    ...
    urls.path("ingredient/<int:pk>", mp_views.IngredientDetailView.as_view(), name="ingredient_detail"),
    urls.path("ingredient/<int:pk>/delete", mp_views.IngredientDeleteView.as_view(), name="ingredient_delete"),
    urls.path("ingredient/<int:pk>/edit", mp_views.IngredientUpdateView.as_view(), name="ingredient_update"),
    urls.path("ingredient/new", mp_views.IngredientCreateView.as_view(), name="ingredient_create"),
